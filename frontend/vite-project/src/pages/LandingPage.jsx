...
const LandingPage = () => {
  ...
  const features = [
    {
      ...
      description: "Create unlimited tasks with titles, descriptions, due dates, and priority levels. Organize everything with intelligent categorization - completely free forever.",
      color: "from-violet-500 to-purple-600"
    },
    {
      icon: <Layers className="h-6 w-6" />,
      title: "Unlimited Workspaces", 
      description: "Create as many workspaces as you need for different projects. Keep work, personal, and side projects perfectly organized without any limits.",
      color: "from-emerald-500 to-teal-600"
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Team Collaboration",
      description: "Invite unlimited team members and assign tasks with different roles. Enable seamless teamwork with role-based access control for everyone.",
      color: "from-blue-500 to-indigo-600"
    },
    {
      icon: <Workflow className="h-6 w-6" />,
      title: "Customizable Workflows",
      description: "Create custom groups and workflow stages that fit your process. Kanban boards, lists, calendar views - all available to everyone for free.",
      color: "from-pink-500 to-rose-600"
    },
    {
      icon: <TrendingUp className="h-6 w-6" />,
      title: "Advanced Analytics",
      description: "Track your productivity with detailed analytics and reports. See your progress over time and identify areas for improvement.",
      color: "from-amber-500 to-orange-600"
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: "Secure & Private",
      description: "Your data is encrypted and secure. We believe privacy should be accessible to everyone, not just those who can afford premium plans.",
  ...
  const communityStats = [
    { icon: <Heart className="h-5 w-5" />, label: "Community Members", value: "50K+" },
    { icon: <MessageCircle className="h-5 w-5" />, label: "Daily Active Users", value: "15K+" },
    { icon: <Code className="h-5 w-5" />, label: "Open Source Contributors", value: "200+" }
  ];
  ...
  const testimonials = [
    {
      ...
      company: "University",
      avatar: "MS",
      content: "As a student on a tight budget, Taskflow has been a lifesaver. I can organize all my assignments and group projects without worrying about subscription fees."
    },
    {
      name: "Ahmed Hassan", 
      role: "Freelancer",
      company: "Independent",
      avatar: "AH",
      content: "Starting my freelance career, I needed something powerful but free. Taskflow gives me everything I need to manage multiple clients and projects."
    },
    {
      name: "Sarah Kim",
      ...
      company: "Local NGO",
      avatar: "SK",
      content: "Our small non-profit can't afford expensive tools. Taskflow helps us coordinate volunteers and manage community projects effectively - all for free!"
    }
  ];
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#features" className="font-medium text-gray-600 hover:text-gray-900 transition-colors">
                Features
              </a>
              <a href="#community" className="font-medium text-gray-600 hover:text-gray-900 transition-colors">
                Community
              </a>
              <a href="#tutorials" className="font-medium text-gray-600 hover:text-gray-900 transition-colors">
                Learn
              </a>
              <a href="#support" className="font-medium text-gray-600 hover:text-gray-900 transition-colors">
                Support
              </a>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 pt-4 border-t border-gray-200 space-y-3">
              <a href="#features" className="block py-2 font-medium text-gray-600">
                Features
              </a>
              <a href="#community" className="block py-2 font-medium text-gray-600">
                Community
              </a>
              <a href="#tutorials" className="block py-2 font-medium text-gray-600">
                Learn
              </a>
              <a href="#support" className="block py-2 font-medium text-gray-600">
                Support
              </a>
              <button 
                onClick={() => window.location.href = '/auth'}
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-xl leading-relaxed text-gray-600">
                We believe productivity tools should be accessible to everyone. Taskflow provides enterprise-grade task management features without any cost, forever. No hidden fees, no premium plans, no limits.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="px-8 py-4 rounded-xl font-semibold text-lg border-2 border-gray-300 text-gray-900 hover:bg-gray-50 transition-all hover:scale-105 flex items-center justify-center space-x-2">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-8 space-y-4 sm:space-y-0 pt-4">
              <div className="flex -space-x-2">
                {[1,2,3,4,5].map(i => (
                  <div key={i} className="w-10 h-10 bg-gradient-to-r from-violet-500 to-purple-600 rounded-full border-2 border-white flex items-center justify-center text-white text-sm font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              We believe that everyone deserves access to powerful productivity tools, regardless of their financial situation. Whether you're a student, starting freelancer, non-profit worker, or simply someone who values free and open software - Taskflow is built for you.
            </p>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 bg-white rounded-xl shadow-sm">
                <Heart className="h-8 w-8 text-red-500 mx-auto mb-4" />
                <h3 className="font-semibold text-gray-900 mb-2">Community Driven</h3>
                <p className="text-sm text-gray-600">Built by the community, for the community. Your feedback shapes our features.</p>
              </div>
              <div className="p-6 bg-white rounded-xl shadow-sm">
                <Lightbulb className="h-8 w-8 text-yellow-500 mx-auto mb-4" />
                <h3 className="font-semibold text-gray-900 mb-2">Open Source</h3>
                <p className="text-sm text-gray-600">Transparent, secure, and constantly improving through collaborative development.</p>
              </div>
              <div className="p-6 bg-white rounded-xl shadow-sm">
                <Globe className="h-8 w-8 text-blue-500 mx-auto mb-4" />
                <h3 className="font-semibold text-gray-900 mb-2">Global Access</h3>
                <p className="text-sm text-gray-600">Breaking down barriers so everyone worldwide can access powerful productivity tools.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl max-w-3xl mx-auto text-gray-600">
              Get all the powerful features you need to manage tasks, collaborate with teams, and boost productivity - completely free, forever.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="p-6 rounded-2xl border bg-white border-gray-100 transition-all hover:shadow-xl hover:-translate-y-1">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Connect with thousands of users, share tips, get help, and contribute to making Taskflow even better
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 bg-gradient-to-r from-violet-500 to-purple-600 rounded-2xl text-white">
              ...
              <p className="mb-6 opacity-90">
                Get help from the community, share your workflows, and discuss new features with fellow users.
              </p>
            ...
            <div className="p-8 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl text-white">
              ...
              <p className="mb-6 opacity-90">
                Help us build new features, fix bugs, and make Taskflow better for everyone. All skill levels welcome!
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See how Taskflow is helping people from all walks of life achieve their goals
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="p-6 rounded-2xl border bg-white border-gray-100 shadow-lg">
      ...
      <section id="support" className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Free support for everyone. Because everyone deserves help when they need it.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 text-center bg-white rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-sm text-gray-600 mb-4">Comprehensive guides and FAQs</p>
            ...
            <div className="p-6 text-center bg-white rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-sm text-gray-600 mb-4">Get help from other users</p>
            ...
            <div className="p-6 text-center bg-white rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-sm text-gray-600 mb-4">Detailed technical docs</p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Powerful task management for everyone. No limits, no costs, no compromise.
              </p>
            ...
            <div>
              ...
              <div className="space-y-3">
                {['Features', 'Tutorials', 'Templates', 'Mobile App'].map(link => (
                  <a key={link} href="#" className="block text-gray-600 hover:text-gray-900 transition-colors">
                    {link}
                  </a>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {['Help Center', 'Documentation', 'Bug Reports', 'Feature Requests'].map(link => (
                  <a key={link} href="#" className="block text-gray-600 hover:text-gray-900 transition-colors">
                    {link}
                  </a>
                ))}
